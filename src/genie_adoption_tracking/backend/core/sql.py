...
class SqlConfig(BaseSettings):
    ...
    # Optional: this app persists to Lakebase and does not query a warehouse at
    # runtime. Left configurable so `Dependencies.Sql` still works if a future
    # route needs it (set DATABRICKS_SQL_WAREHOUSE_ID to enable).
