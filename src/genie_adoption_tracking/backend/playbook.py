...
STAGES: list[dict] = [
    ...
    },
    {
        ...
        "code": "U1",
        "name": "Awareness & Demo",
        "summary": "Demo with known domain assets; start AIM conversations; establish business-user champion(s).",
        "order": 1,
    },
    {
        "key": "u2",
    ...
    },
    {
        ...
        "summary": "Business-user sign-off on accuracy; UCO sizing & forecasting; AIM — Genie Ready.",
        "order": 3,
    },
    {
        "key": "u4",
...
CHECKLIST: list[dict] = [
    ...
    {"key": "u1-hp-aim", "stage": "u1", "lane": "happy_path",
     "label": "Start AIM (Agentic Intelligence / migration) conversations"},
